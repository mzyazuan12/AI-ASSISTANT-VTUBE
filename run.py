...
def translate_text(text):
    ...
    #subtitle = translate_google(text, "EN")
    ...
    # Japanese TTS
    #voicevox_tts(tts) Uncomment this for japanese voicevox AI you can also check full AI preview video on my channel, I have also posted on linkedin as Mohammed Zayan Tariq

    
# Silero TTS, Silero TTS can generate English, Russian, French, Hindi, Spanish, German, etc. Uncomment the line below. Make sure the input is in that language
    silero_tts(tts_en, "indic", "v3_indic", "hindi_male")
